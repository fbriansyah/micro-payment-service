...
SELECT product_code, product_name, product_endpoint FROM products ORDER BY product_name
`
...
func (q *Queries) GetProducts(ctx context.Context) ([]Product, error) {
	...
	for rows.Next() {
		var i Product
		if err := rows.Scan(&i.ProductCode, &i.ProductName, &i.ProductEndpoint); err != nil {
			return nil, err
		}
